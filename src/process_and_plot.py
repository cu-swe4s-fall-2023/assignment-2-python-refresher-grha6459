...
#0year, 1urban population, 2rural population, 3total emissions, 4food transport, 5food consumption
...
plt.close()
# Fig Two: urban/rural ratio of both countries as a function of time
...
plt.close()
# regress food transport emissions as a function of

def ratio_two_columns():
    '''
